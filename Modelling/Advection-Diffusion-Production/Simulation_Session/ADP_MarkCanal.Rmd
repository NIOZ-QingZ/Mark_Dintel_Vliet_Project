...
### Water Budget ####
WaterBudget <- read.csv("C:\\Users\\QingZ\\PhD-Qing\\GitProject\\Mark_Dintel_Vliet_Project_Shared\\Modelling\\Waterbalance\\WaterBudget.csv")

sTime=WaterBudget$sTime

### Input data preparation ####
HF_BlueCh_MarkCanal <- read.csv("C:\\Users\\QingZ\\PhD-Qing\\GitProject\\Mark_Dintel_Vliet_Project_Shared\\Modelling\\Advection-Diffusion-Production\\HF_BlueCh_MarkCanal.csv")
HF_BlueCh_DintelCanal <- read.csv("C:\\Users\\QingZ\\PhD-Qing\\GitProject\\Mark_Dintel_Vliet_Project_Shared\\Modelling\\Advection-Diffusion-Production\\HF_BlueCh_DintelCanal.csv")
HF_BlueCh_Vliet <- read.csv("C:\\Users\\QingZ\\PhD-Qing\\GitProject\\Mark_Dintel_Vliet_Project_Shared\\Modelling\\Advection-Diffusion-Production\\HF_BlueCh_Vliet.csv")

HF_Chla_MarkCanal <- read.csv("C:\\Users\\QingZ\\PhD-Qing\\GitProject\\Mark_Dintel_Vliet_Project_Shared\\Modelling\\Advection-Diffusion-Production\\HF_Chla_MarkCanal.csv")
HF_Chla_DintelCanal <- read.csv("C:\\Users\\QingZ\\PhD-Qing\\GitProject\\Mark_Dintel_Vliet_Project_Shared\\Modelling\\Advection-Diffusion-Production\\HF_Chla_DintelCanal.csv")
HF_Chla_Vliet <- read.csv("C:\\Users\\QingZ\\PhD-Qing\\GitProject\\Mark_Dintel_Vliet_Project_Shared\\Modelling\\Advection-Diffusion-Production\\HF_Chla_Vliet.csv")

mL <- read.csv("C:\\Users\\QingZ\\PhD-Qing\\GitProject\\Mark_Dintel_Vliet_Project_Shared\\Data\\MeteorologicalData\\Radiance.csv")
...
# Temperature data
HF_Temp <- read.csv("C:\\Users\\QingZ\\PhD-Qing\\GitProject\\Mark_Dintel_Vliet_Project_Shared\\Modelling\\Advection-Diffusion-Production\\HF_Temp_MarkCanal.csv")
...
# Nutrient data ####
PO4_MarkCanal <- read.csv("C:\\Users\\QingZ\\PhD-Qing\\GitProject\\Mark_Dintel_Vliet_Project_Shared\\Modelling\\Advection-Diffusion-Production\\LF_PO4_MarkCanal.csv")
PO4_DintelCanal <- read.csv("C:\\Users\\QingZ\\PhD-Qing\\GitProject\\Mark_Dintel_Vliet_Project_Shared\\Modelling\\Advection-Diffusion-Production\\LF_PO4_DintelCanal.csv")
PO4_MVCanal <- read.csv("C:\\Users\\QingZ\\PhD-Qing\\GitProject\\Mark_Dintel_Vliet_Project_Shared\\Modelling\\Advection-Diffusion-Production\\LF_PO4_MVCanal.csv")
PO4_Vliet <- read.csv("C:\\Users\\QingZ\\PhD-Qing\\GitProject\\Mark_Dintel_Vliet_Project_Shared\\Modelling\\Advection-Diffusion-Production\\LF_PO4_Vliet.csv")
