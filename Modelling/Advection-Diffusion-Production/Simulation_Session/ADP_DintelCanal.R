...
HF_Turbidity_MarkCanal <- read.csv("C:\\Users\\QingZ\\PhD-Qing\\GitProject\\Mark_Dintel_Vliet\\Modelling\\Advection-Diffusion-Production\\HF_Turbidity_MarkCanal.csv")

HF_Turbidity_Zevenbergen <- read.csv("C:\\Users\\QingZ\\PhD-Qing\\GitProject\\Mark_Dintel_Vliet\\Modelling\\Advection-Diffusion-Production\\HF_Turbidity_Zevenbergen.csv")

HF_Turbidity_Vliet <- read.csv("C:\\Users\\QingZ\\PhD-Qing\\GitProject\\Mark_Dintel_Vliet\\Modelling\\Advection-Diffusion-Production\\HF_Turbidity_Vliet.csv")

HF_Turbidity_MarkCanal <- approx(HF_Turbidity_MarkCanal$Datum%>%dmy_hms%>%as.numeric, HF_Turbidity_MarkCanal$Waarde, xout=sTime)
MDV_data$Turbidity_MarkCanal[which(MDV_data$sTime%in%HF_Turbidity_MarkCanal$x)] <- HF_Turbidity_MarkCanal$y[which(HF_Turbidity_MarkCanal$x%in%MDV_data$sTime)]
plot(MDV_data$Qin_MarkCanal, MDV_data$Turbidity_MarkCanal)
cor(MDV_data$Qin_MarkCanal, MDV_data$Turbidity_MarkCanal)

HF_Turbidity_Vliet <- approx(HF_Turbidity_Vliet$Datum%>%dmy_hms%>%as.numeric, HF_Turbidity_Vliet$Waarde, xout=sTime)
MDV_data$Turbidity_Vliet[which(MDV_data$sTime%in%HF_Turbidity_Vliet$x)] <- HF_Turbidity_Vliet$y[which(HF_Turbidity_Vliet$x%in%MDV_data$sTime)]
plot(MDV_data$Qout_Vliet, MDV_data$Turbidity_Vliet)
cor(MDV_data$Qout_Vliet, MDV_data$Turbidity_Vliet)

HF_Turbidity_Zevenbergen <- approx(HF_Turbidity_Zevenbergen$Datum%>%dmy_hms%>%as.numeric, HF_Turbidity_Zevenbergen$Waarde, xout=sTime)
MDV_data$Turbidity_Zevenbergen[which(MDV_data$sTime%in%HF_Turbidity_Zevenbergen$x)] <- HF_Turbidity_Zevenbergen$y[which(HF_Turbidity_Zevenbergen$x%in%MDV_data$sTime)]
plot(MDV_data$Qin_BlauweKamer+MDV_data$Qin_Oranjeboombrug+MDV_data$Qin_MarkCanal, MDV_data$Turbidity_Zevenbergen)
cor(MDV_data$Qin_BlauweKamer+MDV_data$Qin_Oranjeboombrug+MDV_data$Qin_MarkCanal, MDV_data$Turbidity_Zevenbergen)
...
Begin_Dintel <- 1 # Place step 114 transition Mark canal to Dintel
Width_Dintel <- 50
Depth_Dintel <- 3
...
Begin_Dintel_wide <- 2 # Here the Dintel becomes much wider
Width_Dintel_wide <- 100
Depth_Dintel_wide <- 3.3
Length_Dintel_wide <- (666-640)*50

Begin_MV_canal <- 3 # place step 666 water disappears in the direction of the non-modelled branch to the discharge sluice_ Transition to the Mark-Vliet canal profile
Width_MV_canal <- 40
Depth_MV_canal <- 2.8
Length_MV_canal <- (743-666)*50

Begin_Vliet_narrow <- 4
...
TotChla[["BlueCh"]]["Time_step 0",]=c(MDV_data$BlueCh_DintelCanal[1], MDV_data$BlueCh_DintelCanal[1], MDV_data$BlueCh_DintelCanal[1], MDV_data$BlueCh_Vliet[1], MDV_data$BlueCh_Vliet[1])

TotChla[["GreenCh"]]["Time_step 0",]=c(MDV_data$dChla_DintelCanal[1], MDV_data$dChla_DintelCanal[1], MDV_data$dChla_DintelCanal[1], MDV_data$dChla_Vliet[1], MDV_data$dChla_Vliet[1])

TotChla[["DiatCh"]]["Time_step 0",]=c(MDV_data$dChla_DintelCanal[1], MDV_data$dChla_DintelCanal[1], MDV_data$dChla_DintelCanal[1], MDV_data$dChla_Vliet[1], MDV_data$dChla_Vliet[1])

TotChla[["BlueCh"]][,"Place_step 0"]=MDV_data$BlueCh_DintelCanal
TotChla[["GreenCh"]][,"Place_step 0"]=MDV_data$dChla_DintelCanal
TotChla[["DiatCh"]][,"Place_step 0"]=MDV_data$dChla_DintelCanal

plot(TotChla[[1]][,1])

Place_step <- c(Length_Dintel, Length_Dintel_wide, Length_MV_canal, Length_Vliet_narrow, Length_Vliet)
Place_Depths <- c(Depth_Dintel, Depth_Dintel_wide, Depth_MV_canal, Depth_Vliet_narrow, Depth_Vliet)
...
plot(MDV_data$Date, MDV_data$PO4_DintelCanal, col=1, ylim = c(0,0.12), ylab = "PO4 (mg/L)", type="l")
lines(MDV_data$Date, MDV_data$PO4_MVCanal, col=2)
lines(MDV_data$Date, MDV_data$PO4_Vliet, col=3)
...
plot(MDV_data$sTime, MDV_data$BlueCh_DintelCanal, t="l", col="red",xaxt="n",ylab = "Blue algae Ch (ug/L)",main = "advection-diffusion + MuTm")
lines(MDV_data$sTime,TotChla[[1]][,2],xlab = "time.step (*day)",t="l",ylim = c(0,100),xaxt="n")
...
legend("topright",legend = c("measurements","simulation"),col = c("red","black"),lty = 1,text.col = c("red","black"))

### Greenalgae:

plot(MDV_data$sTime, MDV_data$dChla_DintelCanal, t="l", col="red",xaxt="n",ylab = "Green algae Ch (ug/L)",main = "advection-diffusion + MuTm")
lines(MDV_data$sTime,TotChla[[2]][,2],xlab = "time.step (*day)",t="l",ylim = c(0,100),xaxt="n")
axis(1,at=as.numeric(ymd_hms(c("2018-01-01 01:00:00","2019-01-01 01:00:00","2020-01-01 01:00:00"))),labels = c("2018-01-01 01:00:00","2019-01-01 01:00:00","2020-01-01 01:00:00"))
...
plot(MDV_data$sTime, MDV_data$dChla_DintelCanal, t="l", col="red",xaxt="n",ylab = "Diatom algae Ch (ug/L)",main = "advection-diffusion + MuTm")
lines(MDV_data$sTime,TotChla[[3]][,2],xlab = "time.step (*day)",t="l",ylim = c(0,100),xaxt="n")
axis(1,at=as.numeric(ymd_hms(c("2018-01-01 01:00:00","2019-01-01 01:00:00","2020-01-01 01:00:00"))),labels = c("2018-01-01 01:00:00","2019-01-01 01:00:00","2020-01-01 01:00:00"))
...
plot(MDV_data$sTime, MDV_data$BlueCh_Vliet, t="l", col="red",xaxt="n",ylab = "Blue algae Ch (ug/L)",main = "advection-diffusion + MuTm",ylim = c(0,400))
lines(MDV_data$sTime,TotChla[[1]][,5],xlab = "time.step (*day)",t="l",ylim = c(0,100),xaxt="n")
axis(1,at=as.numeric(ymd_hms(c("2018-01-01 01:00:00","2019-01-01 01:00:00","2020-01-01 01:00:00"))),labels = c("2018-01-01 01:00:00","2019-01-01 01:00:00","2020-01-01 01:00:00"))
...
plot(MDV_data$sTime, MDV_data$dChla_DintelCanal, t="l", col="red",xaxt="n",ylab = "Green algae Ch (ug/L)",main = "advection-diffusion + MuTm")
lines(MDV_data$sTime,TotChla[[2]][,5],xlab = "time.step (*day)",t="l",ylim = c(0,100),xaxt="n")
axis(1,at=as.numeric(ymd_hms(c("2018-01-01 01:00:00","2019-01-01 01:00:00","2020-01-01 01:00:00"))),labels = c("2018-01-01 01:00:00","2019-01-01 01:00:00","2020-01-01 01:00:00"))
...
plot(MDV_data$sTime, MDV_data$dChla_DintelCanal, t="l", col="red",xaxt="n",ylab = "Diatom algae Ch (ug/L)",main = "advection-diffusion + MuTm")
lines(MDV_data$sTime,TotChla[[3]][,5],xlab = "time.step (*day)",t="l",ylim = c(0,100),xaxt="n")
axis(1,at=as.numeric(ymd_hms(c("2018-01-01 01:00:00","2019-01-01 01:00:00","2020-01-01 01:00:00"))),labels = c("2018-01-01 01:00:00","2019-01-01 01:00:00","2020-01-01 01:00:00"))

legend("topright",legend = c("measurements","simulation"),col = c("red","black"),lty = 1,text.col = c("red","black"))

###############################################
plot(MDV_data$TotChla_DintelCanal,col=1)
lines(TotChla[[1]][,5]+TotChla[[2]][,5]+TotChla[[3]][,5],col=2)
