...
plot(MDV_data$sTime, MDV_data$BlueCh_MarkCanal, t="l", col="red",xaxt="n",ylab = "Blue algae Ch (ug/L)",main = "advection-diffusion + MuTm")
lines(MDV_data$sTime,TotChla[[1]][,1],xlab = "time.step (*day)",t="l",ylim = c(0,100),xaxt="n")
...
plot(MDV_data$sTime, MDV_data$dChla_MarkCanal, t="l", col="red",xaxt="n",ylab = "Green algae Ch (ug/L)",main = "advection-diffusion + MuTm")
lines(MDV_data$sTime,TotChla[[2]][,1],xlab = "time.step (*day)",t="l",ylim = c(0,100),xaxt="n")
axis(1,at=as.numeric(ymd_hms(c("2018-01-01 01:00:00","2019-01-01 01:00:00","2020-01-01 01:00:00"))),labels = c("2018-01-01 01:00:00","2019-01-01 01:00:00","2020-01-01 01:00:00"))
...
plot(MDV_data$sTime, MDV_data$dChla_MarkCanal, t="l", col="red",xaxt="n",ylab = "Green algae Ch (ug/L)",main = "advection-diffusion + MuTm")
lines(MDV_data$sTime,TotChla[[3]][,1],xlab = "time.step (*day)",t="l",ylim = c(0,100),xaxt="n")
axis(1,at=as.numeric(ymd_hms(c("2018-01-01 01:00:00","2019-01-01 01:00:00","2020-01-01 01:00:00"))),labels = c("2018-01-01 01:00:00","2019-01-01 01:00:00","2020-01-01 01:00:00"))
...
lines(MDV_data$sTime,TotChla[[1]][,6],xlab = "time.step (*day)",t="l",ylim = c(0,100),xaxt="n")
axis(1,at=as.numeric(ymd_hms(c("2018-01-01 01:00:00","2019-01-01 01:00:00","2020-01-01 01:00:00"))),labels = c("2018-01-01 01:00:00","2019-01-01 01:00:00","2020-01-01 01:00:00"))
...
######################
plot(TotChla[[1]][,5]+TotChla[[2]][,5]+TotChla[[3]][,5],col=2,t="l")
lines(MDV_data$TotChla_MarkCanal)
